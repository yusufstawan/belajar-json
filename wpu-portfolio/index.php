<?php
$curl = curl_init();
curl_setopt($curl, CURLOPT_URL, 'https://www.googleapis.com/youtube/v3/channels?part=snippet, statistics&id=UCZ1UtmU3YZvXwtQ4-LEVOag&key=AIzaSyDTDJth_AoNHs0HAhZJPV3eUMq-V67wy-4');
        ...
        <div class="row justify-content-center">
          <div class="col-md-5">
            <div class="row">
              ...
              <div class="col-md-8">
                <h5><?= $channelName; ?></h5>
                <p><?= $subsriber; ?> Subsriber</p>
              </div>
            </div>
            <div class="row mt-3 pb-3">
              <div class="col">
                <div class="embed-responsive embed-responsive-16by9">
                <iframe class="embed-responsive-item" src="https://www.youtube.com/watch?v=-BmTKA1xCm8&list=PLFIM0718LjIW7AsIbnhFg15t9yx4H-sQ0&index=6" allowfullscreen></iframe>
              </div>
              </div>
            </div>
          </div>
